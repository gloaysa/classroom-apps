...
const BuzzerGameSelector: FunctionComponent<IBuzzerGameSelector> = ({ onCreateGame, onJoinGame }) => {
	const tabs = [
		{
			title: 'Join game',
...
const GameSelectorJoin: FunctionComponent<{ onJoinGame: (roomId: string) => void }> = ({ onJoinGame }): JSX.Element => {
